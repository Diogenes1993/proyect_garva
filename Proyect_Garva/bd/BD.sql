...
(
    ...
    NRO_BOLETA	    VARCHAR(120) UNIQUE NOT NULL ,
...
SELECT PK_ID_PAGO,NOMBRE_CLIENTE,MONTO,FECHA FROM PAGO_GUARDADO,CLIENTE WHERE PK_ID_CLIENTE=FK_ID_CLIENTE  AND PK_ID_PAGO=1 ORDER BY PK_ID_PAGO;
SELECT * FROM PAGO_GUARDADO;
