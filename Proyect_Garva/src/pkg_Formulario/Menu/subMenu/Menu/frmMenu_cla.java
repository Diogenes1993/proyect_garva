...
import pkg_Formulario.Menu.subMenu.Empleado.Rol.*;
...
public class frmMenu_cla extends javax.swing.JFrame {
/*
    private final IMaster masterI;
    private final MenuTableModel rol_model;
    public frmMenu_cla(IMaster masterI) throws IException {
        initComponents();
        rol_model =new MenuTableModel(masterI.getIRol());
